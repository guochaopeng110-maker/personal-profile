    ...
    cards: [
      {
        ...
        highlights: ['DCS / PLC 设备集成控制', '高并发 Redis 分布式锁', '异构硬件调度状态机', '毫秒级实时通讯总线']
      },
      {
        title: '多维交互与全栈工程的自然演进',
        p: '从底层硬件控制到 Babylon.js 浏览器 3D 渲染，再到大模型驱动的音视频生成流水线，能力链条的持续演进使我具备独特的全场景架构与端到端交付实力。',
        highlights: ['Babylon.js 网页 3D 渲染', 'Shaka Player 双实例拼接', 'Next.js / Node.js 全栈开发', 'PICO VR 凝视交互系统']
      },
      {
        title: 'AI 智能体与智能涌现的工程闭环',
        p: '将传统控制系统的状态机严谨性与大模型的涌现能力相结合，研发生产级 AI 应用与多智能体协同流水线，探索从确定性控制到自主决策的进化。',
        highlights: ['LangGraph 多智能体协同', 'CLI Agent 命令行自愈沙箱', 'OpenClaw 多端聊天接口适配', '多模态 AI 视频自动化生成']
      }
    ]
  },
  timeline: {
